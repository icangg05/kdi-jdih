...
return [
    ...
    'suffix'       => 'JDIH Pemerintah Kota Kendari',
...
<ul>
    <li><a href="#">
        <p>Peraturan Presiden Nomor 33 Tahun 2012 tentang Jaringan Dokumentasi dan Jaringan Informasi Hukum Nasional</p>
    </a></li>
    <li><a href="#">
        <p>Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2019 tentang Standar Pengelolaan Dokumen Dan Informasi Hukum</p>
    </a></li>
    <li><a href="#">
        <p>Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 30 Tahun 2013 tentang Jaringan Dokumentasi dan Informasi Hukum di Lingkungan Kementerian Hukum dan Hak Asasi Manusia.</p>
    </a></li>
</ul>
HTML,
    ],
...
<ul>
  <li>Wadah Jejaring Dokumentasi Hukum secara Tertib, Terpadu, dan Berkesinambungan.</li>
  <li>Instrumen Pelayanan Informasi Hukum secara Mudah, Cepat, dan Terkini</li>
</ul>
...
<p>Jaringan Dokumentasi dan Informasi Hukum Pemerintah Kota Kendari atau disingkat JDIH Pemkot Kendari adalah :</p>
<ul>
  <li>Membangun Jejaring Dokumentasi dan Edukasi Hukum
  </li>
  <li>Instrumen Pelayanan Informasi Hukum Yang Edukatif</li>
</ul>
