		...
		<div class="section">
			...
			<form
				...
				<div class="doc-actions">
					...
					<span class="note doc-note">Batal akan kembali ke daftar monografi tanpa menyimpan.</span>
				</div>
			</form>
		</div>
	</div>
